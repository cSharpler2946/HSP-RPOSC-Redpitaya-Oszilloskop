      ...
      dataAnnotaionPlugin: function(opts){
        ...
        function putBox(ctx, rect, xOff, yOff, lft, top, wid, hgt, strokeWidth, iy, ix, value) {
            ...
            if (strokeWidth) {
                ...
                strokePath.lineTo(lft + rampWidth + strokeWidth / 2, top + strokeWidth / 2);    // /       
                strokePath.lineTo(lft + wid - (rampWidth) - strokeWidth / 2, top + strokeWidth / 2); // -
                strokePath.lineTo(lft - (strokeWidth / 2) + wid, top + hgt / 2 - strokeWidth / 2); // \
                strokePath.lineTo(lft - rampWidth + (strokeWidth / 2) + wid, top + hgt - strokeWidth / 2); // /
                strokePath.lineTo(lft + rampWidth + strokeWidth / 2, top + hgt - strokeWidth / 2); // -
